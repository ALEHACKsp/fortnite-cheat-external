...
#define OFFSET_UWORLD 0x9412AA0
#define SWORD 0x0
#define Bonetoword 0x9412AA0
#define unword 0x9412AA0
#define sword_bone 0x9412AA0
#define compnenttoword 0x9412AA0
...
int main(int argc, const char* argv[])
{
	...
	while (hwnd == NULL)
	{
		SetConsoleTitle("PastaFN Open Source Fixed");
